...
Main:AddToggle("Auto Farm Chest | Normal ",false,function(value)
 AutoFarmChest = value
...
SNt:AddToggle("Auto Farm Shark", _G.AutoKillShark,function(value)
    _G.AutoKillShark = value
    StopTween(_G.AutoKillShark)
end)
SNt:AddToggle("Auto Farm Piranha", _G.AutoKillPiranha,function(value)
    _G.AutoKillPiranha = value
    StopTween(_G.AutoKillPiranha)
end)
SNt:AddToggle("Auto Farm Fish Crew", _G.AutoKillFishCrew,function(value)
...
SNt:AddToggle("Auto Kill Ghost Ship", _G.RelzFishBoat,function(value)
...
SNt:AddToggle("Auto Kill Pirate Brigade", _G.RelzPirateBrigade,function(value)
_G.RelzPirateBrigade = value
StopTween(_G.RelzPirateBrigade)
end)

SNt:AddToggle("Auto Kill Pirate Grand Brigade", _G.RelzPirateGrandBrigade,function(value)
_G.RelzPirateGrandBrigade = value
StopTween(_G.RelzPirateGrandBrigade)
end)

SNt:AddToggle("Auto Kill Terrorshark", _G.AutoTerrorshark,false,function(value)
    _G.AutoTerrorshark = value
   StopTween( _G.AutoTerrorshark)
end)

SNt:AddToggle('Auto Kill Seabest', false,function(value)
    _G.AutoSeaBest = value
...
function CheckSeaBeast()
    ...
    return false
        ...
        SNt:AddToggle("Speed Boat",false,function(value)
            _G.IncreaseBoatSpeed = value
        end)
        ...
        SNt:AddToggle("No Clip Rock",false,function(state)
            _G.NoClipRock = state
            end)
...
SNt:AddToggle("Use Skill Devil Fruit", true, function(value)
    _G.UseSeaFruitSkill = value
end)
SNt:AddToggle("Use Skill Melee", true,function(value)
    _G.UseSeaMeleeSkill = value
end)
SNt:AddToggle("Use Skill Sword", true,function(value)
    _G.UseSeaSwordSkill = value
end)
SNt:AddToggle("Use Skill Gun", true,function(value)
...
SNt:AddToggle("Skill C", true,function(value)
_G.SkillFruitC = value
end)
SNt:AddToggle("Skill V", false,function(value)
_G.SkillFruitV = value
end)
SNt:AddToggle("Skill F", _G.SkillFruitF,function(value)
...
SNt:AddToggle("Skill V", _G.SkillMeleeV,function(value)
