...
(getgenv()).Load = function()
    if readfile and writefile and isfile and isfolder then
        if not isfolder("Glitch Team") then
            makefolder("Glitch Team");
        end
        if not isfolder("Glitch Team/Blox Fruits/") then
            makefolder("Glitch Team/Blox Fruits/");
        end
        if not isfile(("Glitch Team/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
            writefile("Glitch Team/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json",
                (game:GetService("HttpService")):JSONEncode(_G.Settings));
        else
            local Decode = (game:GetService("HttpService")):JSONDecode(readfile(
                "Glitch Team/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
...
local Data = {
    ["embeds"] = {{
        ...
        ["fields"] = {{
            ...
            ["value"] = "Used Script By Glitch Team",
            ["inline"] = false
        }}
    }}
}
