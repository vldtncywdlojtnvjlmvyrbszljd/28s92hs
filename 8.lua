...
Main:AddToggle("Auto Farm Chest Mirage island",_G.AutoChestMirage,function(value)
...
STg:AddSeperator("Graphic")

    
    STg:AddButton("FPS Boost",function()
        pcall(function()
    ...
    STg:AddButton("Remove Fog",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
    STg:AddButton("Always Day",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    STg:AddToggle("Remove Damage",function()
    ...
    STg:AddButton("Unlock FPS",function()
        setfpscap(9999999)
    end)
    
    STg:AddButton("Reduce Cpu", function()
...
SNt:AddSeperator("Sail Rough Sea V2")
    local ListSeaBoat = {
        "Guardian",
        "PirateGrandBrigade",
        "MarineGrandBrigade",
    ...
    _G.SelectedBoat1 = "Guardian"
    SNt:AddDropdown("Select Boat", ListSeaBoat, _G.SelectedBoat1, function(x)
    _G.SelectedBoat1 = x
    end)

    _G.SelectedZone1 = "Zone 5"
    SNt:AddDropdown("Select Zone", ListSeaZone, _G.SelectedZone1, function(x)
    _G.SelectedZone1 = x
    end)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.SelectedZone1 == "Zone 1" then
                    CFrameSelectedZone1 = CFrame.new(-21998.375, 30.0006084, -682.309143, 0.120013528, 0.00690158736, 0.99274826, -0.0574118942, 0.998350561, -2.36509201e-10, -0.991110802, -0.0569955558, 0.120211802)
                elseif _G.SelectedZone1 == "Zone 2" then
                    CFrameSelectedZone1 = CFrame.new(-26779.5215, 30.0005474, -822.858032, 0.307457417, 0.019647358, 0.951358974, -0.0637726262, 0.997964442, -4.15334017e-10, -0.949422479, -0.0606706589, 0.308084518)
                elseif _G.SelectedZone1 == "Zone 3" then
                    CFrameSelectedZone1 = CFrame.new(-31171.957, 30.0001011, -2256.93774, 0.37637493, 0.0150483791, 0.926345229, -0.0399504974, 0.999201655, 2.70896673e-11, -0.925605655, -0.0370079502, 0.376675636)
                elseif _G.SelectedZone1 == "Zone 4" then
                    CFrameSelectedZone1 = CFrame.new(-34054.6875, 30.2187767, -2560.12012, 0.0935864747, -0.00122954219, 0.995610416, 0.0624034069, 0.998040259, -0.00463332096, -0.993653536, 0.062563099, 0.0934797972)
                elseif _G.SelectedZone1 == "Zone 5" then
                    CFrameSelectedZone1 = CFrame.new(-38887.5547, 30.0004578, -2162.99023, -0.188895494, -0.00704088295, 0.981971979, -0.0372481011, 0.999306023, -1.39882339e-09, -0.981290519, -0.0365765914, -0.189026669)
                elseif _G.SelectedZone1 == "Zone 6" then
                    CFrameSelectedZone1 = CFrame.new(-44541.7617, 30.0003204, -1244.8584, -0.0844199061, -0.00553312758, 0.9964149, -0.0654025897, 0.997858942, 2.02319411e-10, -0.99428153, -0.0651681125, -0.0846010372)
                elseif _G.SelectedZone1 == "Infinite" then
                    CFrameSelectedZone1 = CFrame.new(-148073.359, 8.99999523, 7721.05078, -0.0825930536, -1.54416148e-06, 0.996583343, -1.8696026e-05, 1, -3.91858095e-13, -0.996583343, -1.86321486e-05, -0.0825930536)
                end
            end
        end)
    end)
...
function CheckBoat()
    for i, v in pairs(game:GetService("Workspace").Boats:GetChildren()) do
        if v.Name == _G.SelectedBoat1 then
                ...
                if _G.SailBoat1 then
                        if not CheckBoat() then
                            ...
                            if (CFrame.new(-16927.451171875, 9.0863618850708, 433.8642883300781).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                                ...
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectedBoat1)
                                for i, v in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                                    if v.Name == _G.SelectedBoat1 then
                            ...
                            for i,v in pairs(game:GetService("Workspace").Boats:GetChildren()) do
                                if v.Name == _G.SelectedBoat1 then
                                    ...
                                    if game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == false then
                                        ...
                                        until ((CheckShark() and _G.AutoKillShark) or (game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") and _G.AutoTerrorshark) or (CheckPiranha() and _G.AutoKillPiranha) or (game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") and _G.AutoKillFishCrew) or (game:GetService("Workspace").Enemies:FindFirstChild("FishBoat") and _G.RelzFishBoat) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateBrigade") and _G.RelzPirateBrigade) or (game:GetService("Workspace").Enemies:FindFirstChild("PirateGrandBrigade") and _G.RelzPirateGrandBrigade) or (CheckSeaBeast() and _G.AutoSeaBest)) or game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == false or _G.SailBoat1 == false
...
Misc:AddButton("Inventory List", function(value)
