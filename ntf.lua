        ...
        {"MainModule"},
        {
            ...
            {28, "ModuleScript", {"Icons"}},
            {
                ...
                {"Themes"},
                {
                    ...
                    {61, "ModuleScript", {"Matsune"}},
                    {69, "ModuleScript", {"Skyx"}},
...
local aa = {
        ...
        return function(t)
            ...
            function v.Minimize(M)
                ...
                if not C then
                    ...
                    u:Notify {Title = "Interface", Content = "Press " .. N .. " SKYX Hub Hello.", Duration = 6}
                end
            end
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Skyx", "Matsune", "Rose"}}
    ...
    [69] = function()
        ...
        return {
            Name = "Skyx",
            Accent = Color3.fromRGB(232, 120, 7),
            AcrylicMain = Color3.fromRGB(222, 111, 55),
            AcrylicBorder = Color3.fromRGB(232, 120, 7),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(209, 47, 36), Color3.fromRGB(222, 111, 55)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(217, 44, 13),
            Tab = Color3.fromRGB(222, 154, 87),
            Element = Color3.fromRGB(222, 111, 55),
            ElementBorder = Color3.fromRGB(232, 120, 7),
            InElementBorder = Color3.fromRGB(222, 154, 87),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(240, 173, 96),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(240, 173, 96),
            DropdownFrame = Color3.fromRGB(240, 173, 96),
            DropdownHolder = Color3.fromRGB(232, 120, 7),
            DropdownBorder = Color3.fromRGB(191, 43, 33),
            DropdownOption = Color3.fromRGB(140, 120, 160),
            Keybind = Color3.fromRGB(140, 120, 160),
            Input = Color3.fromRGB(140, 120, 160),
            InputFocused = Color3.fromRGB(20, 10, 30),
