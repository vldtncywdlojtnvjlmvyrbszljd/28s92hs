...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://84601195456960"
...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://84601195456960"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://84601195456960"
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        ImageLabel.Image = "rbxassetid://3926311105" --gambar ceklis setelah di klik
