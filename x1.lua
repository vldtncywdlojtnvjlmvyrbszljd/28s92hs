...
getgenv().HyperCahayas = function(p)
    ...
    local QuestItem = Library:AddTab("Quest Item","18477473610")
...
Status:AddSeperator("Status Train V4")
...
spawn(function()
    ...
    spawn(function()
       ...
       Status:AddSeperator("Status Server & Player")

            local Time1 = Status:AddLabel("Run Time Script")
            function UpdateTime()
            ...
            local Client = Status:AddLabel("Client")
            ...
            local Client1 = Status:AddLabel("Client")
            ...
            Status:AddLabel("Executor : ".. identifyexecutor())
            Status:AddLabel("Name : ".. game.Players.LocalPlayer.Name)
...
Farming:AddToggle("Invisible Monsters",_G.inv,function(value)
    ...
    Setting:AddSeperator("Buso Haki State")
    
    Setting:AddDropdown("Select Haki State",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
        _G.SelectStateHaki = value
    end)
    
    Setting:AddButton("Change Buso Haki State",function()
...
Setting:AddSeperator("ESP MENU")

Setting:AddToggle("Esp Mirage Island",false,function(a)
        MirageIslandESP = a
        ...
        Setting:AddToggle("Esp Kitsune Island",false,function(a)
        IslandKitsuneESP = a
        ...
        Setting:AddToggle("ESP Player",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    Setting:AddToggle("ESP Chest",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    Setting:AddToggle("ESP Fruit",false,function(a)
        DevilFruitESP = a
    ...
    Setting:AddToggle("ESP Real Fruit",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    Setting:AddToggle("ESP Flower",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
    ...
    Setting:AddToggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    Setting:AddToggle("Esp Npc", false, function(nec)
    NpcESP = nec
end)

Setting:AddToggle("Esp Sea Beast", false, function(nec)
    SeaESP = nec
end)


Setting:AddToggle("Esp Mob", false, function(nec)
    MobESP = nec
end)
    
Setting:AddSeperator("Setting Farm Mode")

Setting:AddLabel("Pos X Front")
Setting:AddLabel("Pos Y High and low")
    Setting:AddLabel("Pos Z Behind")

    PosX = 1
    Setting:AddSlider("Pos X",0,50,1,function(value)
    PosX = value
    end)

    PosY = 30
    Setting:AddSlider("Pos Y",0,50,45,function(value)
    PosY = value
    end)

    PosZ = 10
    Setting:AddSlider("Pos Z",0,50,40,function(value)
    PosZ = value
    end)
    ...
    Setting:AddSeperator("Setting Skill Gun")

    Setting:AddToggle("Gun Skill Z",true,function(value)
        _G.GunSkillZ = value
    end)

    Setting:AddToggle("Skill Gun X",true,function(value)
        _G.GunSkillX = value
    end)
...
QuestItem:AddSeperator("World")
    end

    if World1 then
        QuestItem:AddToggle("Quest Second Sea",_G.AutoSecondSea,function(value)
            _G.AutoSecondSea = value
    ...
    if World2 then
        ...
        QuestItem:AddToggle("Quest Third Sea",_G.AutoThirdSea,function(value)
            _G.AutoThirdSea = value
    ...
    if World2 then
        ...
        QuestItem:AddToggle("Farm Factory",_G.AutoFactory,function(value)
...
QuestItem:AddSeperator("Fighting Style")
    
QuestItem:AddToggle("Buy Superhuman",_G.AutoSuperhuman,function(value)
        _G.AutoSuperhuman = value
    end)
        ...
        pcall(function()
            if _G.BiirTrax then
                ...
                if targetModel and targetModel:FindFirstChild("VehicleSeat") then
                    local speed = SetSpeedBoat or 150 
...
spawn(function()
    while wait() do
        if _G.AutoKillLeviathan then
            pcall(function()
                for i, v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                    if v and v.Name == "Leviathan Segment" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Health") and v.Health.Value > 0 then
                        AutoHaki()
                        HyperCahaya(v.HumanoidRootPart.CFrame * CFrame.new(1, 450, 45))
                        game:GetService("VirtualUser"):CaptureController()
                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
