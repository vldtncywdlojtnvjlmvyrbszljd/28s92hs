...
-----------------------------------------------------------------------------------------------------------------------------
    ...
    Quest:AddSeperator("World")
    end

    if World1 then
        Quest:AddToggle("Quest Second Sea",_G.AutoSecondSea,function(value)
            _G.AutoSecondSea = value
    ...
    if World2 then
        ...
        Quest:AddToggle("Quest Third Sea",_G.AutoThirdSea,function(value)
            _G.AutoThirdSea = value
    ...
    if World2 then
        ...
        Quest:AddToggle("Farm Factory",_G.AutoFactory,function(value)
...
SeaEvent:AddToggle("Teleport Mystic Island",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            --end
            SeaEvent:AddToggle("Auto Farm Chest Mirage island",_G.AutoChestMirage,function(value)
...
SeaEvent:AddToggle("Auto Boat Drive Press W",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
   pcall(function()
    ...
    SeaEvent:AddToggle("Auto Lock Moon",_G.LockCamToMoon,function(value)
...
spawn(function()
    ...
    SeaEvent:AddToggle("Auto Hop Server Mirage Island", _G.HopFindMirage, function(value)
