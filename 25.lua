...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(224, 128, 18)), ColorSequenceKeypoint.new(0.20, Color3.fromRGB(212, 133, 42)), ColorSequenceKeypoint.new(0.40, Color3.fromRGB(237, 237, 237)), ColorSequenceKeypoint.new(0.60, Color3.fromRGB(237, 237, 237)), ColorSequenceKeypoint.new(0.80, Color3.fromRGB(224, 66, 9)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(191, 34, 13))}
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.AriFast = Value
	if _G.AriFast == "Fast Attack" then
		_G.Fast_Delay = 0.03
	elseif _G.AriFast == "Normal Attack" then
		_G.Fast_Delay = 0.02
	elseif _G.AriFastMode == "Super Fast Attack" then
		_G.Fast_Delay = 0.008
	end
end)

local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Fast attack", Default = True })
...
local Bring = {"Low", "Normal", "Super Bring"}
    ...
    local DropdownDelay = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Bring mode",
        Description = "",
        Values = Bring,
        Multi = false,
    ...
    DropdownDelay:SetValue("Normal")
    DropdownDelay:OnChanged(function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Click", Default = true })
...
local NameQuest = Tabs.Main:AddParagraph({
        Title = "Quest Status",
        Content = ""
    })
    
    local NameMon = Tabs.Main:AddParagraph({
...
spawn(function()
    while task.wait() do
        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
            NameMon:SetDesc("Monster : ...")
            NameQuest:SetDesc("Quest : ...".." | Level : ...")
        elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
            pcall(function()
                CheckLevel()
                NameMon:SetDesc("Monster : ".. NameMon)
                NameQuest:SetDesc("Quest : "..NameQuest.." | Level : "..LevelQuest)
            end)
        end
    end
end)
...
if Third_Sea then
    ...
    local StatusSeaRough = Tabs.Sea:AddParagraph({
    Title = "Sea Rough",
    Content = ""
})
...
local AutoKillEventToggle = Tabs.Sea:AddToggle("AutoKillEvent_Toggle", {Title = "Auto Kill [Event]", Default = false })
...
local AutoKillTerrorsharkToggle = Tabs.Sea:AddToggle("AutoKillTerrorshark_Toggle", {Title = "Auto Kill Terrorshark", Default = false })
...
local AutoKillPiranhaToggle = Tabs.Sea:AddToggle("AutoKillPiranha_Toggle", {Title = "Auto Kill Piranha", Default = false })
...
local AutoKillSharkToggle = Tabs.Sea:AddToggle("AutoKillShark_Toggle", {Title = "Auto Kill Shark", Default = false })
...
local AutoKillFishCrewMemberToggle = Tabs.Sea:AddToggle("AutoKillFishCrewMember_Toggle", {Title = "Auto Kill Fish Crew Member", Default = false })
...
local No_clipRockBoatToggle = Tabs.Sea:AddToggle("No_clipRockBoat_Toggle", {Title = "Noclip Rock", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Farm Seabeast",Description = "", Default = false })
...
Skillf:OnChanged(function(value)
    ...
    local AutoMysticIsland = Tabs.Main:AddSection("migare island")


    Tabs.Main:AddButton({
        Title = "tele migare island ",
        Description = "",
        Callback = function()
            TweenMirage()
        end
...
if Second_Sea then
    local ToggleEvoRace = Tabs.Main:AddToggle("ToggleEvoRace", {Title = "Get race V2",Description = "",Default = false })
...
local ToggleEspChest = Tabs.Fruit:AddToggle("ToggleEspChest", {Title = "Esp chest",Description = "", Default = false })
...
Tabs.Race:AddButton({
        ...
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(29012.341796875, 14890.9755859375, -380.1492614746094))
        end
    })
...
Tabs.Race:AddButton({
        ...
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(28502.681640625, 14895.9755859375, -423.7279357910156))
        end
    })
...
Tabs.Race:AddButton({
        ...
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(28231.17578125, 14890.9755859375, -211.64173889160156))
        end
    })
...
Tabs.Race:AddButton({
        ...
        Description = "Tele",
        Callback = function()
toTargetP(CFrame.new(29221.822265625, 14890.9755859375, -205.99114990234375))
        end
    })
...
Tabs.Race:AddButton({
        ...
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(28674.244140625, 14890.6767578125, 445.4310607910156))
        end
    })

Tabs.Race:AddButton({
        Title = "Teleport Angle Door",
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(28960.158203125, 14919.6240234375, 235.03948974609375))
        end
    })
    
    Tabs.Race:AddButton({
        Title = "Teleport Ancient One",
        Description = "Tele",
        Callback = function()
    toTargetP(CFrame.new(28975.416015625, 14889.9755859375, -119.18738555908203))
        end
    })

local Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Kill Player After Trial!", Default = false })
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://107679910024355"--17221942833"
...
button.Size = UDim2.new(0, 50, 0, 50) -- Set size
button.Position = UDim2.new(0, 10, 0.2, -25) -- Set position to the left with an X offset of 10 pixel
button.BackgroundColor3 = Color3.fromRGB(255, 124, 50) -- Set button background color to red
