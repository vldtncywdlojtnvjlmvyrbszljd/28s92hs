...
function getLink()
    return fStringFormat("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/28s92hs/main/key.txt;
end;
...
function verify(key)
    ...
    if (useDataModel) then
        local status, result = pcall(function() 
            return game:HttpGetAsync(fStringFormat("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/28s92hs/main/key.txt", key));
        end);
            ...
            elseif string.find(result, "false") then
                ...
                if true then
                    local status1, result1 = pcall(function()
                        return game:HttpPostAsync(fStringFormat("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/28s92hs/main/key.txt", key), {});
                    end);
        ...
        local status, result = pcall(function() 
            return fRequest({
                Url = fStringFormat("https://raw.githubusercontent.com/vldtncywdlojtnvjlmvyrbszljd/28s92hs/main/key.txt", key),
                Method = "GET"
            });
        end);
