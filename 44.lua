...
local Library = Update:Window("Nasa","Hub",Enum.KeyCode.RightControl);
...
Shop:Button("Random Race (Use 3K Fragments)", function()
 ...
 Misc:Button("Destroy Ui",function()
     if game.CoreGui:FindFirstChild("NEXUZ HUB") then
         game.CoreGui:FindFirstChild("NEXUZ HUB"):Destroy()
