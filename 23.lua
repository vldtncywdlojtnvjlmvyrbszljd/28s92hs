...
local Library = Update:Window("E Slash Hub","6023426909",Enum.KeyCode.RightControl);
Main = Library:Tab("Main","6023426909")

Main:Seperator("Welcome To E Slash Hub")
...
Main:Toggle("Auto Super Fast Attck",false,function(x)
    _G.AutoFastAttack = x
end)
