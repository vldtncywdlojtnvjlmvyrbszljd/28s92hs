...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 40 or MyLevel <= 59 then
            ...
            NameMon = "Brute"
            CFrameQuest = CFrame.new(-1141.07483, 4.10001802, 3831.5498, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
            CFrameMon = CFrame.new(-1074.80103, 22.0785007, 4487.10107, 0.995646179, -5.45884618e-08, -0.0932131708, 6.38921875e-08, 1, 9.68269802e-08, 0.0932131708, -1.02361007e-07, 0.995646179)
        ...
        while wait() do
            pcall(function()
                if _G.KillPlayer then
                    ...
                    until not _G.KillPlayer or not _G.TargTrial or _G.TargTrial.Character.Humanoid.Health <= 0
                end
            end)
        end
    end)
